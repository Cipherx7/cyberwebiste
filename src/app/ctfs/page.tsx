...
export default function CTFsPage() {
    return (
        <div className="bg-black min-h-screen relative overflow-hidden">
            {/* BACKGROUND ELEMENTS */}
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_rgba(var(--color-target),0.05),_transparent_60%)] pointer-events-none" />
            ...
            <SectionContainer id="ctfs-page" title="Capture The Flag">
                ...
                <div className="relative z-10 max-w-5xl mx-auto">
                    ...
                    <div className="text-center mb-16">
                        ...
                        >
                            <div className="relative mb-6">
                                <div className="absolute -inset-4 bg-[rgb(var(--color-target))] opacity-20 blur-xl rounded-full" />
                                <Flag size={64} className="text-[rgb(var(--color-target))] relative z-10" />
                            </div>
                        </MotionDiv>

                        <h2 className="text-4xl sm:text-6xl font-extrabold mb-4 tracking-tight">
                            CyberX <span className="text-[rgb(var(--color-target))]">CTF Arena</span>
                        </h2>
                    ...
                    <MotionDiv
                        ...
                        className="mb-20"
                    >
                        <div className="relative overflow-hidden rounded-2xl bg-[rgba(255,196,0,0.05)] border border-[rgba(255,196,0,0.3)] p-8 sm:p-12 text-center">
                            {/* Stripe Pattern */}
                            <div className="absolute inset-0 bg-[repeating-linear-gradient(45deg,rgba(0,0,0,0)_0px,rgba(0,0,0,0)_10px,rgba(255,196,0,0.03)_10px,rgba(255,196,0,0.03)_20px)] pointer-events-none" />

                            <div className="relative z-10">
                                <div className="inline-flex items-center gap-2 px-4 py-1 rounded-full bg-[rgb(var(--color-target))] text-black font-bold text-sm mb-6 animate-pulse">
                                ...
                                <div className="flex items-center justify-center gap-2 opacity-50">
                                    <div className="h-1 w-12 bg-[rgb(var(--color-target))]" />
                                    <div className="h-1 w-2 bg-[rgb(var(--color-target))]" />
                                    <div className="h-1 w-12 bg-[rgb(var(--color-target))]" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        <MotionDiv
                            ...
                            className="bg-[rgba(20,20,20,0.6)] backdrop-blur border border-white/10 rounded-xl p-6 hover:border-[rgb(var(--color-target))] transition-colors"
                        >
