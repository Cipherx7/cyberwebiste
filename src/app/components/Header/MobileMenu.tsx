          ...
          {show && (
            <>
              ...
              <motion.div
                ...
                className="fixed inset-y-0 right-0 z-[101] w-[85%] max-w-sm bg-black/90 backdrop-blur-xl border-l border-white/10 shadow-2xl flex flex-col"
              >
                <div className="flex items-center justify-between p-6 border-b border-white/5">
                  <span className="text-xl font-bold font-orbitron tracking-wider">
                    CYBER<span className="text-target">X</span>
                  </span>
                  <button
                    onClick={() => setShow(false)}
